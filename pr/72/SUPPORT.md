...
Thanks for using nectar! Before filing an issue, there are a few places
...
- If it’s a question: It’s best to ask on the [Data Science Learning
  Community Slack](https://dslc.io). Other options include [Posit
...
- If it’s a bug: you’re in the right place, [file an
  issue](https://github.com/api2r/nectar/issues/new).
...
requests](https://github.com/api2r/nectar/issues) to make sure the bug
