...
- [`call_api()`](https://nectar.api2r.org/dev/reference/call_api.md)
  **\[questioning\]** : Send a request to an API
...
- [`compact_nested_list()`](https://nectar.api2r.org/dev/reference/compact_nested_list.md)
  : Discard empty elements
- [`do_if_fn_defined()`](https://nectar.api2r.org/dev/reference/do_if_fn_defined.md)
  : Use a provided function
- [`iterate_with_json_cursor()`](https://nectar.api2r.org/dev/reference/iterate_with_json_cursor.md)
  : Iteration helper for json cursors
- [`req_auth_api_key()`](https://nectar.api2r.org/dev/reference/req_auth_api_key.md)
  : Authenticate with an API key
- [`req_init()`](https://nectar.api2r.org/dev/reference/req_init.md) :
  Setup a basic API request
- [`req_modify()`](https://nectar.api2r.org/dev/reference/req_modify.md)
...
- [`req_pkg_user_agent()`](https://nectar.api2r.org/dev/reference/req_pkg_user_agent.md)
  : Append package information to user agent
- [`req_prepare()`](https://nectar.api2r.org/dev/reference/req_prepare.md)
...
- [`resp_body_csv()`](https://nectar.api2r.org/dev/reference/resp_body_csv.md)
  [`resp_body_tsv()`](https://nectar.api2r.org/dev/reference/resp_body_csv.md)
  : Extract tabular data from response body
- [`resp_body_separate()`](https://nectar.api2r.org/dev/reference/resp_body_separate.md)
...
- [`resp_tidy_unknown()`](https://nectar.api2r.org/dev/reference/resp_tidy_unknown.md)
  : Error informatively for unknown response types
- [`url_normalize()`](https://nectar.api2r.org/dev/reference/url_normalize.md)
  : Normalize a URL
- [`url_path_append()`](https://nectar.api2r.org/dev/reference/url_path_append.md)
